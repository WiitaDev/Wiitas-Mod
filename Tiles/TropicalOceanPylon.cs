...
{
    public class TropicalOceanPylon : ModPylon
    {
        ...
        public override void Load()
        {
            ...
            crystalHighlightTexture = ModContent.Request<Texture2D>(Texture + "_Crystal");
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<TropicalOceanPylonItem>();
        }
        ...
        public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData)
        {
            ...
            return ModContent.GetInstance<TropicalOceanTileCount>().tropicalSandCount >= 40;
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<TropicalOceanPylonItem>().DisplayName.Key, ref mouseOverText);
        }
    }
}