...
namespace WiitaMod.Particles
{
    public class SmokeParticle : Particle //this is lifted form the public calamity mod repository
    {
        ...
        public override string Texture => "WiitaMod/Particles/Smoke";
        ...
        {
            if (TimeActive / (float)Lifetime < 0.2f)
                Scale += 0.01f;
            else
                Scale *= 0.975f;
        ...
        public override void CustomDraw(SpriteBatch spriteBatch)
        {
            ...
            int animationFrame = (int)Math.Floor(TimeActive / ((float)(Lifetime / (float)FrameAmount)));
