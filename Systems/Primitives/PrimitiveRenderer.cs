...
namespace WiitaMod.Systems.Primitives // Yoinked from the public calamity repository (also removed the pixelation as I currently dont need it)
{
    /// <summary>
    ...
    public static class PrimitiveRenderer
    {
        ...
        private static void PrivateRender()
        {
            ...
            Matrix view;
            Matrix projection;
            CalculatePerspectiveMatricies(out view, out projection);

            var shaderToUse = MainSettings.Shader ?? GameShaders.Misc["WiitaMod:StandardPrimitiveShader"];
