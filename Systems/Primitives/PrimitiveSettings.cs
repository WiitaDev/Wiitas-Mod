...
namespace WiitaMod.Systems.Primitives
{
    /// <summary>
    ...
    public readonly struct PrimitiveSettings
    {
        ...
        public PrimitiveSettings(VertexWidthFunction widthFunction, VertexColorFunction colorFunction, VertexOffsetFunction offsetFunction = null, bool smoothen = true, MiscShaderData shader = null, (Vector2, Vector2)? initialVertexPositionsOverride = null)
        {
