...
namespace WiitaMod.Systems.BossSystems
{
    public class BossChecklistSystem : ModSystem
    {
        ...
        private void DoBossChecklistIntegration()
        {
            ...
            string internalName = "KapitalismiBoss";

            LocalizedText spawnInfo = Language.GetOrRegister("Mods.WiitaMod.BossChecklist.Kapitalismi.SpawnInfo");

            // Value inferred from boss progression, see the wiki for details
            float weight = 4.9999f; // after evil boss

            // Used for tracking checklist progress
            Func<bool> downed = () => DownedBossSystem.downedKapitalismiBoss;

            // The NPC type of the boss
            int bossType = ModContent.NPCType<CrystalBoss>();
