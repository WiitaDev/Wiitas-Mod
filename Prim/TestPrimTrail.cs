...
{
    public class TestPrimTrail : PrimTrail
    {
        public TestPrimTrail(Projectile projectile, float width)
        {
            Entity = projectile;
        ...
        public override void SetShaders()
        {
            ...
            effect.Parameters["uTexture"].SetValue(ModContent.Request<Texture2D>("WiitaMod/Assets/Textures/GlowTrail", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value);
