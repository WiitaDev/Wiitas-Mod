                ...
                {//Spawn projectiles to the marked enemy
                    ...
                    if (GalacticSwipeTimer == 6)
                    {
                        ...
                        if (Main.myPlayer == player.whoAmI && Main.gamePaused == false)
                        {
                            ...
                            Projectile.NewProjectile(player.GetSource_FromThis(), npc.Center - vector * 20f, vector, ModContent.ProjectileType<TestingProjectile>(), GalacticBassBowDamage - GalacticBassBowDamage / 4, 0f, Main.myPlayer, 0f, npc.Center.Y);
                        }
                    }
                }
            }
