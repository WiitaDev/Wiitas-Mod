    ...
    internal class ExampleAdvancedDust : ModDust
    {
		...
		*/
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            int desiredVanillaDustTexture = 91;
        ...
        public override bool Update(Dust dust)
        {
            ...
            if (dust.customData != null && dust.customData is NPC target)
            {
                ...
                dust.position = target.Center + Vector2.UnitX.RotatedBy(dust.rotation, Vector2.Zero) * dust.scale * 50;
            }
