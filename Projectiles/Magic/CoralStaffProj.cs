...
namespace WiitaMod.Projectiles.Magic
{
    public class CoralStaffProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            /*Effect noiseTrailEffect = ModContent.Request<Effect>("WiitaMod/Effects/MotionNoiseTrail", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            noiseTrailEffect.Parameters["uTexture"].SetValue(ModContent.Request<Texture2D>("WiitaMod/Assets/Textures/voronoiLooping", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value);
            ...
            Texture2D bloom = Mod.Assets.Request<Texture2D>("Assets/Textures/CircleGradient", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            Main.EntitySpriteDraw(bloom, drawPoint[Base] - Main.screenPosition, null, Color.LightBlue * .4f, 0, bloom.Size() / 2, ScaleX * .5f, SpriteEffects.None, 0);*/

            Effect blurEffect = ModContent.Request<Effect>("WiitaMod/Effects/BlurLine").Value;
